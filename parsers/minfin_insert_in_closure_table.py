...
try:
    ...
    values_to_be_inserted = str(comment_id) + "," + str(comment_id) + "," +"0,0," + str(post_id)
    print("VALUES: ", values_to_be_inserted)
    ...
    cur.execute("INSERT INTO comments_tree (idAncestor, idDescendant, idNearestAncestor, commentLevel, idSubject) VALUES (" + values_to_be_inserted + ")")
    
    print("INSERTED successfully into comments_tree ...")
